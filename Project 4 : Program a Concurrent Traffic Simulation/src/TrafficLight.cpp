...
T MessageQueue<T>::receive()
{
    ...
    // remove element from queue because we want most recent state. 
    _queue.pop_back(); 
...
void TrafficLight::waitForGreen()
{
    ...
    while(true){
        auto temp = _message_queue.receive();

        if( temp == TrafficLightPhase::green){
            return void(); 
        }
    }
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    //Duration of a single simulation cycle in seconds, is randomly chosen    
